...
const iupc_data: CONTEST_DATA[] = [

    {
        ...
        data: [
            ...
            {
                contestTitle: 'CEFALO SUST Inter University Programming Contest',
                contestDate: '2023-01-28',
                standingLink: 'https://toph.co/c/sust-inter-university-2023/standings/kiosk',
                totalParticipatingTeam: 50,
                ...
                universityTeams: [
                    {
                        ...
                        totalSolved: 3,
                        penalty: 507,
                        teamName: 'AUST_Partisans',
                        teamMembers: ['NIRJOY DEBNATH', 'SOHOM MUNASIB SAHAUN', 'PARVEZ MIA']
                    },
